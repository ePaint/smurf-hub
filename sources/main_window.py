...
class MainWindow(QWidget):
    ...
    def init_accounts_table(self):
        ...
        self.accounts_table.setColumnWidth(0, 85)
        self.accounts_table.setColumnWidth(1, 150)
        self.accounts_table.setColumnWidth(2, 75)
        self.accounts_table.setColumnWidth(3, 75)
